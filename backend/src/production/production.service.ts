...
export class ProductionService {
  ...
  async completeOrder(
    ...
    let deductStockForConsumptions = false;
    ...
    if (deductStockForConsumptions && supplyConsumptions && supplyConsumptions.length > 0) {
      // Restore previous consumptions to avoid double deduction
