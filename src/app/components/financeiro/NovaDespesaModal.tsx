...
export default function NovaDespesaModal({ isOpen, onClose, onSave, initialData }: NovaDespesaModalProps) {
  ...
  const { costCenters, accountingCategories, accountingSubcategories, suppliers } = useCadastros();
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl my-8">
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-800">{initialData ? 'Editar Despesa' : 'Nova Despesa'}</h2>
        ...
        <form onSubmit={handleSubmit} className="p-4 flex flex-col gap-4 max-h-[70vh] overflow-y-auto">
          <div>
            ...
            <input
              ...
              placeholder="Ex: Fornecedor de Insumos - Coalho"
            />
          </div>
