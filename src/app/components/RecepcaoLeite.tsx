                ...
                {filteredLotes.map((lote) => {
                  ...
                  return (
                    <tr key={lote.id} className="hover:bg-gray-50">
                      ...
                      <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{produtor?.name}</td>
                      <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{rota?.name}</td>
