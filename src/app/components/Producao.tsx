                ...
                {ordensProducao.map((op) => {
                  ...
                  return (
                    <tr key={op.id} className="hover:bg-gray-50">
                      <td className="whitespace-nowrap px-6 py-4 font-medium">{op.numero}</td>
                      <td className="whitespace-nowrap px-6 py-4">{produto?.name || '-'}</td>
                      <td className="whitespace-nowrap px-6 py-4 text-sm">{lote?.codigo || '-'}</td>
